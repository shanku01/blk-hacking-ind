...
export function adjustForInflation(amount, inflation, years) {
...
export function calculateNpsTaxBenefit(invested, annualIncome) {
    const deduction = Math.min(invested, 0.1 * annualIncome, 200000);
